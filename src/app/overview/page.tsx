...
export default function OverviewPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white">Tổng quan dự án</h1>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card className="lg:col-span-2" hover>
          ...
          <CardContent className="space-y-3 text-sm leading-relaxed text-slate-300">
            ...
            <p>
              <strong className="text-sky-300">Nhánh nhập khẩu:</strong> hàng NK
        ...
        <Card hover>
          ...
          <CardContent className="space-y-3 text-sm">
            <div className="rounded-xl border border-white/5 bg-white/[0.03] p-3">
              ...
              <div className="mt-1 text-slate-200">{SOURCES.word}</div>
            </div>
            <div className="rounded-xl border border-white/5 bg-white/[0.03] p-3">
              <div className="text-[10px] font-bold uppercase tracking-wider text-slate-500">Excel</div>
              <div className="mt-1 text-slate-200">{SOURCES.excel}</div>
            ...
            <div className="rounded-xl border border-white/5 bg-white/[0.03] p-3">
              ...
              <div className="mt-1 text-slate-200">{SOURCES.ppt}</div>
        ...
        <Card hover>
          ...
          <CardContent className="text-sm text-slate-300">
            <ol className="list-decimal space-y-2 pl-5">
              ...
              <li><strong className="text-emerald-300">Lưu kho chồng kiện</strong> (giảm diện tích thuê)</li>
              <li>Thông quan</li>
